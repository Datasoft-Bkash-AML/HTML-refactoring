<?php
// Converted from tmp_chunks/chunk-21.html
// Promotions product carousel (cleaned, sample data)
$products = [
...
<section class="promo-carousel">
  ...
  <div class="splide" role="region" aria-roledescription="carousel" aria-label="Promotional items carousel" data-splide-options='<?php echo htmlspecialchars(json_encode($splide_opts), ENT_QUOTES, "UTF-8"); ?>'>
      ...
      <ul class="splide__list" role="list">
        <?php foreach($products as $p): ?>
          <li class="splide__slide product-card" role="option" aria-label="<?php echo htmlspecialchars($p['title']); ?>">
            ...
            <a class="btn" href="#" role="button" aria-label="Quick view for <?php echo htmlspecialchars($p['title']); ?>">Quick view</a>
          </li>
        <?php endforeach; ?>
      </ul>
    </div>
