<?php
// chunk-60..64: cross-sells bubble and carousel (JS templates preserved)
?>
<div class="rey-crossSells-bubble --loading" role="region" aria-label="Product suggestions">
    <div class="rey-crossSells-bubble-title">You may also like&hellip;</div>

    <div class="rey-crossSells-item __cart-product" aria-hidden="true">
    ...
    <div class="splide rey-crossSells-carousel --loading" data-slider-config='<?php echo htmlspecialchars(json_encode($cross_cfg), ENT_QUOTES, "UTF-8"); ?>' role="region" aria-roledescription="carousel" aria-label="Suggested products">
        ...
        <div class="splide__track">
            <div class="rey-crossSells-itemsWrapper splide__list">
                <!-- JS template: for (var i = 0; i < items.length; i++) { ... } -->
                <!-- Each slide HTML preserved and rendered by client JS -->
            </div>
        </div>
    </div>
</div>
